"""
Django settings for Django_baza1 project.
...
SECRET_KEY = 'django-insecure-(7e$5c_=w+1d1ixnez^pq2ia58l7wts)k5w+9e1nmr0r-$xnk2'
...
ROOT_URLCONF = 'Django_baza1.urls'
...
WSGI_APPLICATION = 'Django_baza1.wsgi.application'
